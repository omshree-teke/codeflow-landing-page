...
// Auto-completed by AI}`,
  ...
  },
  {
    ...
    description:
      "Generate comprehensive test suites automatically. Our AI analyzes your codebase to create unit, integration, and edge-case tests, ensuring reliability and reducing manual effort.",
...
it("should login successfully", () => {
  ...
  },
  {
    ...
    description:
      "Identify and fix bugs before they reach production. AI-powered error detection pinpoints issues, suggests fixes, and helps you resolve problems faster with intelligent insights.",
            ...
            <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition==="right" ? "lg:flex-row-reverse" : ""}`}>
              ...
              <div className="flex-1 w-full">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 to-purple-500/20 rounded-xl sm:rounded-2xl transition-all duration-500"></div>
