const testimonials = [
  {
    ...
    content:
      "This AI-powered devlopment platform has revolutionized how we write code. the intelligent suggestions save us every day",
  },
  {
    name: "James Miller",
    ...
    content:
      "The automated testing feature alone is worth it. It catches bugs I would have missed and saves hours of manual testing every sprint.",
  },
  {
    name: "David Park",
    ...
    content:
      "Smart debugging has completely changed our workflow. What used to take hours to diagnose now takes minutes. Absolutely indispensable tool.",
  },
];
                    ...
                    <div className="flex items-start space-x-3 sm:space-x-4">
                        ...
                        <div className="flex-grow">
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <img src={testimonial.image} alt={testimonials.name} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover"/>
                                <div>
